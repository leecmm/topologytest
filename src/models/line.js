...
var Line = /** @class */ (function (_super) {
    ...
    function Line(json) {
        ...
        if (json) {
            if (json.from) {
                _this.from = new Point(json.from.x, json.from.y, json.from.direction, json.from.anchorIndex, json.from.id);
            }
            if (json.to) {
                _this.to = new Point(json.to.x, json.to.y, json.to.direction, json.to.anchorIndex, json.to.id);
            }
    ...
    Line.prototype.draw = function (ctx) {
        ...
        if ((!this.isAnimate || this.animateType !== "comet") &&
    ...
    Line.prototype.calcRectInParent = function (parent) {
        ...
        this.rectInParent = {
            x: ((this.from.x - parent.rect.x - parent.paddingLeftNum) * 100) /
                parentW +
                "%",
