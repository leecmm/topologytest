...
export function registerNode(name, drawFn, anchorsFn, iconRectFn, textRectFn, force) {
...
// force - Overwirte the node if exists.
export function registerLine(name, drawFn, drawControlPointsFn, controlPointsFn, dockControlPointFn, pointInFn, force) {
    if (force === void 0) { force = true; }
    // Exist
...
// drawFn - how to draw.
// force - Overwirte the node if exists.
export function registerArrow(name, drawFn, force) {
    if (force === void 0) { force = true; }
    // Exist
